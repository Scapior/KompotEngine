...
{
template<typename charType = char, typename T, std::size_t hexLenght = sizeof(T*) << 1>
auto hexFromPointer(const T* const pointer, StringCaseOption stringCaseOption = StringCaseOption::Lowercase, TrimOption trimOption = TrimOption::Trim)
{
